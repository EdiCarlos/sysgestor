...
--
-- Table structure for table `unidmedida`
--
...
CREATE TABLE `unidmedida` (
  `idunidmedida` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `unidmedida`
--

LOCK TABLES `unidmedida` WRITE;
/*!40000 ALTER TABLE `unidmedida` DISABLE KEYS */;
INSERT INTO `unidmedida` VALUES (1,'UN',0);
